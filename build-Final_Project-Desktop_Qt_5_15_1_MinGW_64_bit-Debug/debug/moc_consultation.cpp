...
#include <memory>
#include "../../Final_Project/consultation.h"
...
QT_MOC_LITERAL(3, 36, 23) // "on_pushButton_2_clicked"
    ...
    "consultation\0on_pushButton_clicked\0\0"
...
void consultation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<consultation *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject consultation::staticMetaObject = { {
    ...
    qt_meta_stringdata_consultation.data,
    qt_meta_data_consultation,
    qt_static_metacall,
    nullptr,
    nullptr
} };
